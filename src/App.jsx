    ...
    <>
      <div className="w-full flex flex-col items-center shadow-md">
        ...
        <div className="w-full flex  bg-white">
          <div className="flex  mt-0 ms-[136px]">
            <button
      ...
      <div className="container px-4 sm:px-6 mx-auto [@media(min-width:1280px)]:max-w-[1300px] [@media(min-width:1280px)]:px-12  [@media(min-width:1480px)]:px-4">
        <Navbar />
        <Hero />
        <Ourfeatures/>
      </div>
